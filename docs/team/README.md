...
- All 26 agents (24 specialists + 2 verifiers) with roles
...
- `../../.claude/agents/*.md` — The 26 agent prompts. Read individual agents when deep-diving.
- `../../.claude/hooks/*.sh` — Protocol enforcement hooks (auto-run by Claude Code).
- `../../.claude/tests/agents/` — Contract test suite (286 assertions across 26 agents).
