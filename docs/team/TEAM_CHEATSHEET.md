...
python3 .claude/tests/agents/run_contract_tests.py   # expected: 286 passed
```
...
| `.claude/agents/*.md` | 26 agent prompts (24 specialists + 2 verifiers) |
...
*Last updated: 2026-04-18 — v3.0 with 26 agents, hiring pipeline, Shadow Mind.*
